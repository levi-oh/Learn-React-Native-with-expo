...
function Home({ navigation, route }) {
  ...
  React.useLayoutEffect(() => {
    navigation.setOptions({
      headerRight: () => (
        <View>
        <Button onPress={() => setCount((c) => c + 1)} title='Update count' />
        <Button onPress={() => navigation.navigate("Home",{screen:"HomeIn",countNum: 123})} title='set count' />
        </View>
      ),
    });
  }, [navigation, setCount]);
  return (
    <Tab.Navigator>
      <Tab.Screen name='HomeIn' component={HomeScreen} />
